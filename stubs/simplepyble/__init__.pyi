...
class Adapter:
    ...
    def scan_for(self, timeout: int | float) -> None: ...
    def scan_get_results(self) -> Sequence[Peripheral]: ...
...
class Peripheral:
    ...
    def write(self, service_uuid: str, char_uuid: str, data: bytes) -> None: ...
    def rssi(self) -> int: ...
    ...
    def write_command(self, service_uuid: str, char_uuid: str, data: bytes) -> None: ...
    def write_request(self, service_uuid: str, char_uuid: str, data: bytes) -> None: ...
