...
class TestBluetoothSIGTranslator:
    ...
    def test_translator_methods_exist(self):
        ...
        assert hasattr(translator, "list_supported_characteristics"), "Translator should have list_supported_characteristics method"
    ...
    def test_no_connection_methods(self):
        ...
        assert not hasattr(translator, "read_parsed_characteristics"), "Translator should not have read_parsed_characteristics method"
