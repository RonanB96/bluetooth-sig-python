...
from bluetooth_sig.gatt.characteristics import PreferredUnitsCharacteristic
from bluetooth_sig.gatt.characteristics.preferred_units import PreferredUnitsData
