...
class TestGlucoseMeasurementCharacteristic:
    ...
    def test_glucose_measurement_basic_parsing(self, glucose_measurement_char):
        ...
        test_data = bytearray([
            ...
            0xE8, 0x07, 0x03, 0x0F, 0x0E, 0x1E, 0x2D,  # timestamp: 2024-03-15 14:30:45
            0x80, 0x17  # glucose: 120.0 mg/dL as SFLOAT
        ])
    ...
    def test_glucose_measurement_with_mmol_unit(self, glucose_measurement_char):
        ...
        test_data = bytearray([
            ...
            0xE8, 0x07, 0x01, 0x0F, 0x0A, 0x1E, 0x00,  # timestamp
            0x5C, 0x16  # glucose: 6.7 mmol/L as SFLOAT
        ])
    ...
    def test_glucose_measurement_with_time_offset(self, glucose_measurement_char):
        ...
        test_data = bytearray([
            ...
            0x40, 0x16  # glucose: 100.0 mg/dL as SFLOAT
        ])
    ...
    def test_glucose_measurement_with_sensor_status(self, glucose_measurement_char):
        ...
        test_data = bytearray([
            ...
            0xE8, 0x07, 0x01, 0x0F, 0x0A, 0x1E, 0x00,  # timestamp
            0x40, 0x16,  # glucose: 100.0 mg/dL as SFLOAT
            0x01, 0x00  # sensor status: device battery low
        ])
    ...
    def test_glucose_type_names(self, glucose_measurement_char):
        ...
        assert glucose_measurement_char._get_glucose_type_name(1) == "Capillary Whole blood"
        assert glucose_measurement_char._get_glucose_type_name(9) == "Interstitial Fluid (ISF)"
    ...
    def test_sample_location_names(self, glucose_measurement_char):
        ...
        assert glucose_measurement_char._get_sample_location_name(2) == "Alternate Site Test (AST)"
...
class TestGlucoseMeasurementContextCharacteristic:
    ...
    def test_glucose_context_with_carbohydrate(self, glucose_context_char):
        ...
        test_data = bytearray([
            ...
            0x40, 0x1C  # carbohydrate: 50.0g as SFLOAT
        ])
    ...
    def test_glucose_context_with_exercise(self, glucose_context_char):
        ...
        test_data = bytearray([
            ...
            0x01, 0x00,  # sequence number = 1
            0x58, 0x02,  # exercise duration: 600 seconds (10 minutes)
    ...
    def test_glucose_context_type_names(self, glucose_context_char):
        ...
        assert glucose_context_char._get_tester_type_name(2) == "Health Care Professional"
        assert glucose_context_char._get_health_type_name(5) == "No health issues"
        assert glucose_context_char._get_medication_type_name(1) == "Rapid acting insulin"
...
class TestGlucoseFeatureCharacteristic:
    ...
    def test_glucose_feature_descriptions(self, glucose_feature_char):
        ...
        assert "Low Battery Detection" in glucose_feature_char.get_feature_description(0)
