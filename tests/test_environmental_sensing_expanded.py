...
from ble_gatt_device.gatt.characteristics.true_wind_speed import TrueWindSpeedCharacteristic
from ble_gatt_device.gatt.characteristics.true_wind_direction import TrueWindDirectionCharacteristic
from ble_gatt_device.gatt.characteristics.apparent_wind_speed import ApparentWindSpeedCharacteristic
from ble_gatt_device.gatt.characteristics.apparent_wind_direction import ApparentWindDirectionCharacteristic
from ble_gatt_device.gatt.services.environmental_sensing import EnvironmentalSensingService
...
class TestEnvironmentalSensingExpanded:
    ...
    def test_environmental_sensing_service_expansion(self):
        ...
        new_characteristics = [
            ...
            "Apparent Wind Speed", "Apparent Wind Direction"
        ]
