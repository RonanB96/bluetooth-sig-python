...
from bluetooth_sig.registry.uuids.declarations import DeclarationsRegistry, get_declarations_registry
...
class TestDeclarationsRegistry:
    ...
    def test_registry_initialization(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        declarations = get_declarations_registry().get_all_declarations()
    ...
    def test_get_declaration_info(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        info = get_declarations_registry().get_declaration_info("0x2800")
    ...
    def test_get_declaration_info_by_name(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        info = get_declarations_registry().get_declaration_info_by_name("Primary Service")
        if info:  # Only if YAML loaded
            assert isinstance(info, DeclarationInfo)
            assert info.name == "Primary Service"
        ...
        info_lower = get_declarations_registry().get_declaration_info_by_name("primary service")
        assert info_lower == info

        # Test not found
        info_none = get_declarations_registry().get_declaration_info_by_name("Nonexistent Declaration")
    ...
    def test_get_declaration_info_by_id(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        # Test not found
        info_none = get_declarations_registry().get_declaration_info_by_id("org.bluetooth.attribute.gatt.nonexistent")
        assert info_none is None
    ...
    def test_get_declaration_info_by_bluetooth_uuid(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        info = get_declarations_registry().get_declaration_info(bt_uuid)
        if info:  # Only if YAML loaded
            assert isinstance(info, DeclarationInfo)
            assert info.name == "Primary Service"
    ...
    def test_get_declaration_info_not_found(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        info = get_declarations_registry().get_declaration_info("nonexistent")
        assert info is None

        info = get_declarations_registry().get_declaration_info("0x0000")  # Not a declaration UUID
        assert info is None
    ...
    def test_is_declaration_uuid(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        has_declarations = bool(get_declarations_registry().get_all_declarations())
        assert get_declarations_registry().is_declaration_uuid("0x2800") or not has_declarations

        # Non-declaration UUID
        assert not get_declarations_registry().is_declaration_uuid("0x0000")

        # Invalid UUID
        assert not get_declarations_registry().is_declaration_uuid("invalid")
    ...
    def test_uuid_formats(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        for fmt in formats:
            info = get_declarations_registry().get_declaration_info(fmt)
            if get_declarations_registry().is_declaration_uuid("2800"):
    ...
    def test_known_declarations(self, declarations_registry: DeclarationsRegistry) -> None:
        ...
        primary_service = get_declarations_registry().get_declaration_info("0x2800")
        if primary_service:
        ...
        secondary_service = get_declarations_registry().get_declaration_info("0x2801")
        ...
        # Test Include
        include = get_declarations_registry().get_declaration_info("0x2802")
        if include:
            assert include.name == "Include"
            assert include.id == "org.bluetooth.attribute.gatt.include_declaration"

        # Test Characteristic
        characteristic = get_declarations_registry().get_declaration_info("0x2803")
        if characteristic:
