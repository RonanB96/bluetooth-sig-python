...
class TestBitFieldUtils:  # pylint: disable=too-many-public-methods
    ...
    def test_extract_bit_field_edge_cases(self):
    ...
    def test_extract_bit_field_invalid_params(self):
    ...
    # Test set_bit_field
    def test_set_bit_field_basic(self):
    ...
    def test_set_bit_field_edge_cases(self):
    ...
    def test_set_bit_field_invalid_params(self):
    ...
    # Test create_bitmask
    def test_create_bitmask_basic(self):
    ...
    def test_create_bitmask_invalid_params(self):
    ...
    def test_test_bit_edge_cases(self):
    ...
    def test_test_bit_invalid_params(self):
    ...
    def test_bit_operations_invalid_params(self):
    ...
    def test_validate_bit_field_range(self):
    ...
    def test_shift_bit_field_right(self):
    ...
    def test_merge_bit_fields(self):
    ...
    def test_compare_bit_fields(self):
    ...
    def test_extract_bit_field_from_mask(self):
    ...
    def test_ble_flag_handling(self):
    ...
    def test_cycling_power_data_parsing(self):
