...
class TestBodyCompositionMeasurementCharacteristic:
    ...
    def test_parse_with_muscle_mass_metric(self):
        ...
        # Flags: 0x0010 (muscle mass present), Body Fat: 250, Muscle Mass: 10000 (50.0 kg)
    ...
    def test_parse_with_muscle_mass_imperial(self):
        ...
        # Flags: 0x0011 (imperial + muscle mass), Body Fat: 250, Muscle Mass: 11000 (110.0 lb)
...
class TestBodyCompositionFeatureCharacteristic:
    ...
    def test_parse_basic_features(self):
        ...
        # Features: 0x0000001F (timestamp, multiple users, basal metabolism, muscle mass, muscle %)
...
class TestBodyCompositionService:
    ...
    def test_expected_characteristics(self):
        ...
        assert expected["Body Composition Measurement"] == BodyCompositionMeasurementCharacteristic
        assert expected["Body Composition Feature"] == BodyCompositionFeatureCharacteristic
    ...
    def test_required_characteristics(self):
        ...
        assert required["Body Composition Measurement"] == BodyCompositionMeasurementCharacteristic
