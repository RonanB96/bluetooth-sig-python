...
from bluetooth_sig.registry.core.formattypes import get_format_types_registry
...
class TestFormatTypesIntegration:
    ...
    def test_registry_loads_format_types(self) -> None:
        ...
        format_types = get_format_types_registry().get_all_format_types()
    ...
    def test_format_type_info_structure(self) -> None:
        ...
        info = get_format_types_registry().get_format_type_info(0x01)
    ...
    def test_utf16_format_type_present(self) -> None:
        ...
        # Also check by name
        utf16s_by_name = get_format_types_registry().get_format_type_by_name("utf16s")
