...
|---------|---------|----------|
| **Registry Pattern** | Dynamic discovery of characteristics | [internals.md](deep-dive/internals.md) |
| **Singleton Pattern** | Single translator/registry instances | [internals.md](deep-dive/internals.md) |
| **Template Method** | Abstract parsing contracts | [internals.md](deep-dive/internals.md) |
| **Lazy Initialization** | On-demand data loading | [registry-system.md](deep-dive/registry-system.md) |
...
- **[Internal Architecture](deep-dive/internals.md)** - Detailed implementation of core systems
- **[Registry System](deep-dive/registry-system.md)** - Deep dive into UUID registry and YAML loading

### For Contributing

- **[Adding Characteristics](../guides/adding-characteristics.md)** - Step-by-step guide for new characteristics
- **[Contributing Guide](../contributing.md)** - Development setup and workflows

### For Performance

- **[Performance Guide](../guides/performance.md)** - Optimization techniques
- **[Benchmarks](../benchmarks.md)** - Live benchmark results
