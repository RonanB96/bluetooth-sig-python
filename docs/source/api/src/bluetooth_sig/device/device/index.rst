...
.. py:module:: src.bluetooth_sig.device.device
...
.. autoapisummary::
   ...
   src.bluetooth_sig.device.device.DependencyResolutionMode
   src.bluetooth_sig.device.device.Device
   src.bluetooth_sig.device.device.SIGTranslatorProtocol


Module Contents
---------------

.. py:class:: DependencyResolutionMode(*args, **kwds)
   ...
   .. py:attribute:: SKIP_DEPENDENCIES
      :value: 'skip_dependencies'
...
.. py:class:: Device(address: str, translator: SIGTranslatorProtocol)
   ...
   :param translator: SIGTranslatorProtocol instance
