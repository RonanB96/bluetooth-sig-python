...
.. py:class:: ConcentrationTemplate(resolution: float = 1.0)
   ...
   :param resolution: Measurement resolution (e.g., 1.0 for integer ppm, 0.1 for 0.1 ppm)
...
.. py:class:: ScaledSint16Template(scale_factor: float = 0.01, offset: int = 0)
   ...
   :param scale_factor: Factor to multiply raw value by
   :param offset: Offset to add to raw value before scaling
...
.. py:class:: ScaledUint32Template(scale_factor: float = 0.1, offset: int = 0)
   ...
   :param scale_factor: Factor to multiply raw value by (e.g., 0.1 for 1 decimal place)
   :param offset: Offset to add to raw value before scaling
...
.. py:class:: Utf8StringTemplate(max_length: int = 256)
   ...
   :param max_length: Maximum string length in bytes
