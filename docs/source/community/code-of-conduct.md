...
1. **Stereotyping or discrimination.** Characterizing anyone’s personality or behaviour on the basis of immutable identities or traits.
...
1. **Irresponsible communication.** Failing to responsibly present content which includes, links or describes any other restricted behaviours.
...
When an incident does occur, it is important to report it promptly. To report a possible violation, email <RonanB96@users.noreply.github.com>.
...
1. Temporary Suspension
   ...
   1. Consequence: A private written warning with conditions for return from suspension. In general, temporary suspensions give the person being suspended time to reflect upon their behaviour and possible corrective actions.
...
1. Permanent Ban
   ...
   1. Consequence: Access to all community spaces, tools, and communication channels is removed. In general, permanent bans should be rarely used, should have strong reasoning behind them, and should only be resorted to if working through other remedies has failed to change the behaviour.
...
This Code of Conduct is adapted from the Contributor Covenant, version 3.0, permanently available at [Contributor Covenant 3.0](https://www.contributor-covenant.org/version/3/0/).
