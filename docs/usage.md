...
- [Quick Start Guide](quickstart.md) - Basic getting started
- [BLE Integration Guide](guides/ble-integration.md) - Connect with bleak, simplepyble, etc.
- [Supported Characteristics](supported-characteristics.md) - Complete list of supported GATT characteristics
