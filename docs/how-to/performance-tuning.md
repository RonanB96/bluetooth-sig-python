...
- [Performance Benchmark Data](../reference/performance-data.md) - Detailed timing measurements
- [Live Benchmarks](../reference/benchmarks.md) - Real-time performance dashboard
