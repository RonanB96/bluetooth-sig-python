...
class GATTSensorTranslator:
    ...
    @staticmethod
    def translate_to_ha_sensor(characteristic: BaseCharacteristic, raw_data: bytearray) -> Dict[str, Any]:
    ...
    def get_sensor_configuration(characteristic: BaseCharacteristic) -> Dict[str, Any]:
        ...
        return {
            ...
            "state_class": characteristic.state_class,
            "unit_of_measurement": characteristic.unit,
            "icon": GATTSensorTranslator._get_icon_for_device_class(characteristic.device_class),
        }
    ...
    @staticmethod
    def batch_translate_characteristics(characteristics: Dict[str, BaseCharacteristic], 
                                      characteristic_data: Dict[str, bytearray]) -> Dict[str, Dict[str, Any]]:
