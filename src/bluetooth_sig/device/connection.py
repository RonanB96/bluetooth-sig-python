...
Defines an async protocol that adapter implementations (Bleak,
SimplePyBLE, etc.) should follow so the `Device` class can operate
...
class ConnectionManagerProtocol(Protocol):
    ...
    libraries like Bleak. Synchronous libraries can be wrapped by
    adapters.
    """
