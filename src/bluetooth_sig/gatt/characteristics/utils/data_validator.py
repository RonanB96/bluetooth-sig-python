...
class DataValidator:
    ...
    @staticmethod
    def validate_data_length(data: bytearray, expected_min: int, expected_max: int | None = None) -> None:
    ...
    def validate_enum_value(value: int, enum_class: type[IntEnum]) -> None:
        ...
        try:
            ...
            raise EnumValueError(enum_class.__name__, value, enum_class, valid_values) from e

    @staticmethod
    def validate_concentration_range(value: float, max_ppm: float = MAX_CONCENTRATION_PPM) -> None:
