...
class ParentGroupObjectIdCharacteristic(BaseCharacteristic[int]):
    """Parent Group Object ID characteristic (0x2B9F).

    org.bluetooth.characteristic.parent_group_object_id

    OTS object ID for the parent group.
    """
