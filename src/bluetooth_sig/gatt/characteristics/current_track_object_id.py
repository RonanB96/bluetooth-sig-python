...
class CurrentTrackObjectIdCharacteristic(BaseCharacteristic[int]):
    """Current Track Object ID characteristic (0x2B9D).

    org.bluetooth.characteristic.current_track_object_id

    OTS object ID for the current track.
    """
