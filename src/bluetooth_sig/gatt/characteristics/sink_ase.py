...
class SinkASEData(msgspec.Struct, frozen=True, kw_only=True):  # pylint: disable=too-few-public-methods
...
class SinkASECharacteristic(BaseCharacteristic[SinkASEData]):
    """Sink ASE characteristic (0x2BC4).
    ...
    def _decode_value(
        ...
        ase_state = ASEState(DataParser.parse_int8(data, 1, signed=False))
        additional_data = (
    ...
    def _encode_value(self, data: SinkASEData) -> bytearray:
        """Encode Sink ASE data to bytes."""
        result = bytearray()
