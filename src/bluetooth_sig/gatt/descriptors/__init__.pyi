...
from .cccd import CCCDDescriptor
from .characteristic_aggregate_format import CharacteristicAggregateFormatDescriptor
from .characteristic_extended_properties import CharacteristicExtendedPropertiesDescriptor
...
from .external_report_reference import ExternalReportReferenceDescriptor
from .imd_trigger_setting import IMDTriggerSettingDescriptor
from .manufacturer_limits import ManufacturerLimitsDescriptor
from .measurement_description import MeasurementDescriptionDescriptor
from .number_of_digitals import NumberOfDigitalsDescriptor
from .observation_schedule import ObservationScheduleDescriptor
from .process_tolerances import ProcessTolerancesDescriptor
from .registry import DescriptorRegistry
from .report_reference import ReportReferenceDescriptor
from .server_characteristic_configuration import ServerCharacteristicConfigurationDescriptor
from .time_trigger_setting import TimeTriggerSettingDescriptor
from .valid_range import ValidRangeDescriptor
from .valid_range_and_accuracy import ValidRangeAndAccuracyDescriptor
from .value_trigger_setting import ValueTriggerSettingDescriptor
