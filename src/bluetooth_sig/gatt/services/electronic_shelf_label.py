...
class ElectronicShelfLabelService(BaseGattService):
    ...
    service_characteristics: ClassVar[dict[CharacteristicName, bool]] = {
        ...
        CharacteristicName.ESL_CONTROL_POINT: True,
        CharacteristicName.ESL_CURRENT_ABSOLUTE_TIME: True,
        ...
        CharacteristicName.ESL_RESPONSE_KEY_MATERIAL: True,
        CharacteristicName.ESL_SENSOR_INFORMATION: False,
        CharacteristicName.AP_SYNC_KEY_MATERIAL: True,
    }
