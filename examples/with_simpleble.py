...
Requirements:
    ...
    # Alternative Linux-only: pip install simplebluez
...
try:
    ...
    try:
        ...
        print(
            "⚠️  SimplePyBLE/SimpleBluez not available. This is a demonstration of the integration pattern."
        )
        print("Install options:")
        print("  Cross-platform: pip install simplepyble")
        print("  Linux only: pip install simplebluez")
