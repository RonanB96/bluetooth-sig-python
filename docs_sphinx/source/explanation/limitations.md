...
**See the [Adding New Characteristics Guide](../how-to/adding-characteristics.md) for complete examples.**
...
- [Quick Start](../tutorials/quickstart.md) - Get started with usage
- [BLE Integration Guide](../how-to/ble-integration.md) - Integrate with BLE libraries
