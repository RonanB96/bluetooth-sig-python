src.bluetooth_sig.core
======================

.. py:module:: src.bluetooth_sig.core
...
.. toctree::
   ...
   /reference/api/src/bluetooth_sig/core/async_context/index
   /reference/api/src/bluetooth_sig/core/translator/index
...
.. autoapisummary::
   ...
   src.bluetooth_sig.core.AsyncParsingSession
   src.bluetooth_sig.core.BluetoothSIGTranslator
