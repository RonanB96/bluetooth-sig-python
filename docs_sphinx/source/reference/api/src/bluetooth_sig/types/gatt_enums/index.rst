src.bluetooth_sig.types.gatt_enums
==================================

.. py:module:: src.bluetooth_sig.types.gatt_enums
...
.. autoapisummary::
   ...
   src.bluetooth_sig.types.gatt_enums.logger
...
.. autoapisummary::
   ...
   src.bluetooth_sig.types.gatt_enums.DayOfWeek
   src.bluetooth_sig.types.gatt_enums.AdjustReason
   src.bluetooth_sig.types.gatt_enums.GattProperty
   src.bluetooth_sig.types.gatt_enums.ValueType
   src.bluetooth_sig.types.gatt_enums.DataType
   src.bluetooth_sig.types.gatt_enums.CharacteristicName
   src.bluetooth_sig.types.gatt_enums.ServiceName
...
.. py:class:: AdjustReason
   ...
   .. py:attribute:: MANUAL_TIME_UPDATE
      :value: 1



   .. py:attribute:: EXTERNAL_REFERENCE_TIME_UPDATE
      :value: 2



   .. py:attribute:: CHANGE_OF_TIME_ZONE
      :value: 4



   .. py:attribute:: CHANGE_OF_DST
      :value: 8



   .. py:method:: from_raw(value: int) -> AdjustReason
      :classmethod:
...
.. py:class:: GattProperty(*args, **kwds)
   ...
   .. py:attribute:: WRITE_WITHOUT_RESPONSE
   ...
   .. py:attribute:: INDICATE
      :value: 'indicate'



   .. py:attribute:: AUTHENTICATED_SIGNED_WRITES
      :value: 'authenticated-signed-writes'



   .. py:attribute:: EXTENDED_PROPERTIES
      :value: 'extended-properties'



   .. py:attribute:: RELIABLE_WRITE
      :value: 'reliable-write'



   .. py:attribute:: WRITABLE_AUXILIARIES
      :value: 'writable-auxiliaries'



   .. py:attribute:: ENCRYPT_READ
      :value: 'encrypt-read'



   .. py:attribute:: ENCRYPT_WRITE
      :value: 'encrypt-write'



   .. py:attribute:: ENCRYPT_NOTIFY
      :value: 'encrypt-notify'



   .. py:attribute:: AUTH_READ
      :value: 'auth-read'



   .. py:attribute:: AUTH_WRITE
      :value: 'auth-write'



   .. py:attribute:: AUTH_NOTIFY
      :value: 'auth-notify'



.. py:class:: ValueType(*args, **kwds)
...
.. py:class:: DataType(*args, **kwds)
   ...
   .. py:attribute:: MEDFLOAT16
      :value: 'medfloat16'



   .. py:attribute:: MEDFLOAT32
      :value: 'medfloat32'
   ...
   .. py:method:: from_string(type_str: str | None) -> DataType
      :classmethod:


      Convert string representation to DataType enum.

      :param type_str: String representation of data type (case-insensitive)

      :returns: Corresponding DataType enum, or DataType.UNKNOWN if not found



   .. py:method:: to_value_type() -> ValueType

      Convert DataType to internal ValueType enum.

      :returns: Corresponding ValueType for this data type



   .. py:method:: to_python_type() -> str

      Convert DataType to Python type string.

      :returns: Corresponding Python type string
