...
:::{tip}
**New to the library?** Start with [Installation](installation.md), then proceed to the [Quick Start](quickstart.md) tutorial to parse your first characteristic in under 5 minutes.
:::
...
Need to solve a specific problem instead? Check out the [How-to Guides](../how-to/index.md).
